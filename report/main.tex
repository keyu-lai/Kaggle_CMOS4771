...
% affiliations
\author{\IEEEauthorblockN{Bach Viet Do}
...
In this part we have tried different classification algorithms and they all achieve fair performances as a single classifier. To boost the performance, we train each model independently and implement an blending algorithm to combine them. In this section, we will briefly introduce the each algorithm and the blending algorithm we created.
